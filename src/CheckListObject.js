...
export const PhaseThreeList = 
    {phaseTitle:"How to kill a dragon", 
        ...
        tasks:[
            ...
            {index:2, id:"Ph-3,T-3", taskName:"Blow him up", isChecked:false},
            {index:3, id:"Ph-3,T-4", taskName:"Rip its heart out", isChecked:false},
            {index:4, id:"Ph-3,T-5", taskName:"Still moves? Repeat it in the same order again, until it stops", isChecked:false}],
        // statusOfAll:[false,false]
}